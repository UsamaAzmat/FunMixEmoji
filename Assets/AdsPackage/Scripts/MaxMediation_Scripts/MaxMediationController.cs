...
public class MaxMediationController : MonoBehaviour
{
    ...
    private void OnInterstitialFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
    {
        ...
        Debug.Log("MAX Interstitial failed to load with error code: " + errorInfo.Code);
    ...
    private void InterstitialFailedToDisplayEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo, MaxSdkBase.AdInfo adInfo)
    {
        ...
        Debug.Log("MAX Interstitial failed to display with error code: " + errorInfo.Code);
        LoadInterstitial();
    }
  ...
  new Firebase.Analytics.Parameter("currency", "USD"), // All AppLovin revenue is sent in USD
    ...
    {
        currentPlacement = PlayerPrefs.GetString("AdPlacement");
        // Rewarded ad is hidden. Pre-load the next ad
        Debug.Log("MAX Rewarded ad dismissed");
        GameAnalytics.NewAdEvent(GAAdAction.Show, GAAdType.RewardedVideo, "Max", currentPlacement);
    ...
    private void OnRewardedAdReceivedRewardEvent(string adUnitId, MaxSdk.Reward reward, MaxSdkBase.AdInfo adInfo)
    {
        ...
        OnRewardedComplete.instance?.GiveReward();
  ...
  new Firebase.Analytics.Parameter("currency", "USD"), // All AppLovin revenue is sent in USD
    ...
    private void OnRewardedInterstitialAdFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
    {
        ...
        Debug.Log("MAX Rewarded interstitial ad failed to load with error code: " + errorInfo.Code);
    ...
    private void OnRewardedInterstitialAdFailedToDisplayEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo, MaxSdkBase.AdInfo adInfo)
    {
        ...
        Debug.Log("MAX Rewarded interstitial ad failed to display with error code: " + errorInfo.Code);
        LoadRewardedInterstitialAd();
    }
  ...
  new Firebase.Analytics.Parameter("currency", "USD"), // All AppLovin revenue is sent in USD
    ...
    private void OnBannerAdFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
    {
        ...
        RemoteValues.Instance.isShowingAdmob = true;
    }
  ...
  new Firebase.Analytics.Parameter("currency", "USD"), // All AppLovin revenue is sent in USD
    ...
    private void OnMRecAdFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
    {
        ...
        Debug.Log("MAX MRec ad failed to load with error code: " + errorInfo.Code);
    }
